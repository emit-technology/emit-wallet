...
function getShortAddress(shotAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var rest;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rpc_1["default"].post("sero_getShortAddress", [shotAddress], types_1.ChainType.SERO)];
                case 1:
                    rest = _a.sent();
...
function getDeviceLv(rate) {
    if (rate) {
        return utils.fromValue(rate, 16).toFixed(2, 1);
    }
    return "0";
}
exports.getDeviceLv = getDeviceLv;
function nFormatter(n, digits) {
    var num = new bignumber_js_1["default"](n).toNumber();
    var si = [
        { value: 1, symbol: "" },
        { value: 1E3, symbol: "K" },
        { value: 1E6, symbol: "M" },
...
function calcDark(dna) {
    var u256 = new BN(dna.slice(2), 16).toArrayLike(Buffer, "be", 64);
    return u256[0] & 0x3 + 1;
}
exports.calcDark = calcDark;
function isDark(dna) {
    var u256 = new BN(dna.slice(2), 16).toArrayLike(Buffer, "be", 64);
