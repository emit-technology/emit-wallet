...
class ResetAccount extends React.Component<any, State> {
    ...
    confirm = async () => {
        ...
        const accountId:any = await walletWorker.resetAccount(mnemonic, password);
        if(accountId){
            ...
            <IonPage>
                <IonContent fullscreen>
                    ...
                    <IonList>
                        ...
                        {/*</IonItem>*/}
                        {/*{*/}
                        {/*    !!accountIdLocal && <IonItem mode="ios" onClick={(e)=> this.setState({resetPassword: !resetPassword})}>*/}
                        {/*        <IonCheckbox slot="start" checked={resetPassword}/>*/}
                        {/*        <IonLabel><IonText >Reset password</IonText></IonLabel>*/}
                        {/*    </IonItem>*/}
                        {/*}*/}
                        {
                            !accountIdLocal || resetPassword &&
                            <>
                                <IonItem mode="ios">
                                    <IonLabel position="stacked"><IonText
                        ...
                        {
                            !!accountIdLocal && <IonItem lines="none">
                                <IonLabel className="ion-text-wrap">
                                    EMIT-Wallet does not keep a copy of your password. If you’re having trouble unlocking your account, you will need to reset your wallet. You can do this by providing the Secret Recovery Phrase or Private Key you  once used when you set up your wallet.
                    ...
                    <div className="button-bottom">
                        <IonButton mode="ios" expand="block"
                                   disabled={showProgress || !mnemonic || !password || !rePassword}
                                   onClick={() => {
                                       this.setState({
                                           showProgress: true,
                                       })
